...
try {
    ...
    $stmt = $conn->prepare("SELECT * FROM inventory WHERE invID=:iidParam");
    $stmt->bindParam(':iidParam', $_GET["iid"]);
    $stmt->execute();
...
<form method="POST" action="store_deleted_inventory.php">
  Inventory ID:<br>
...
<p>If you click the "Submit" button, the form-data will be deleted.</p>
<br><br>
