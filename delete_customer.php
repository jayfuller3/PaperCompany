...
<form method="POST" action="store_deleted_customer.php">
  Customer name:<br>
  <input type="hidden" name="fcid" value="<?php echo $custid; ?>">
  <input type="text" name="fcustname" disabled value="<?php echo $custname; ?>">
  <br><br>
  Contact Person:<br>
  <input type="text" name="fcontact" disabled value="<?php echo $custcontact; ?>">
  <br><br>
  Phone:<br>
  <input type="text" name="fphone" disabled value="<?php echo $custphone; ?>">
  <br><br>
  <br><br>
  <input type="submit" value="Confirm Delete">
</form> 

<p>If you click the "Confirm Delete" button, the customer will be removed.</p>
<br><br>
